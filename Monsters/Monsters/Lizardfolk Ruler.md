...
actions:
  - name: Multiattack.
    desc: "The lizardfolk ruler makes two Bite attacks and one Greataxe attack, or it makes three Javelin attacks."
  - name: Bite.
    desc: "*Melee Weapon Attack:* +5 to hit, reach 5 ft., one target.  *Hit:* 10 (2d6 + 3) piercing damage."
  - name: Greataxe.
    desc: "*Melee Weapon Attack:* +5 to hit, reach 5 ft., one target.  *Hit:* 16 (2d12 + 3) slashing damage."
  - name: Javelin.
