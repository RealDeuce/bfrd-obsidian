...
bonus_actions:
  - name: Fan the Flames.
    desc: "The scorch drake flaps its wings in the direction of one ignited creature it can see within 15 feet of it. The flames coating the target flare up and generate excess smoke. The target must succeed on a DC 15 CON save or be [[../../Conditions/Blinded|blinded]] until the end of its next turn."
traits:
  - name: Heat Shimmer.
...
actions:
  ...
  - name: Bite.
    desc: "*Melee Weapon Attack:* +6 to hit, reach 5 ft., one target.  *Hit:* 12 (2d8 + 3) piercing and 3 (1d6) fire damage."
  - name: Claw.
    desc: "*Melee Weapon Attack:* +6 to hit, reach 5 ft., one target.  *Hit:* 8 (2d4 + 3) slashing and 3 (1d6) fire damage."
