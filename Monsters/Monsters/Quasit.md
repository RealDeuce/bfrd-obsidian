...
actions:
  ...
  - name: Invisibility (True Form Only).
    desc: "The quasit magically turns [[../../Conditions/Invisible|invisible]] until it attacks, uses Scare, or uses Change Shape, or until its concentration ends (as if concentrating on a spell). Any equipment the quasit wears or carries is invisible with it."
ac: 13
size: Tiny
speed: 40 ft.
hp: 35
